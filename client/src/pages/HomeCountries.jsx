...
import { getCountries, filterCountriesByRegion, filterActivity, orderByName, orderByPopulation, getActivity } from '../actions/index';
    ...
    return(
        <div>
            ...
            <div className={s.filter}>
                ...
                <select onChange={e => handleSortByPopulation(e)} className={s.select}>
            ...
            {currentCountries?.map((c, i) =>{
                ...
                return(
                    <Fragment key={c.id}>
                        <Card name={c.name} image={c.image} region={c.region} id={c.id} population={c.population} capital={c.capital}/>
                    </Fragment>
                );
                })
            }
            ...
            <button className={s.btn} onClick={e => handleClick(e)}>Reload Country</button>
            </div>
        </div>
